...
const p_presale_mint_whitelisted = "(CAUTION: only one purchase allowed. Make sure to select the right amount) You're on the whitelist for the pre-sale! 🎉";
...
const p_presale_mint_whitelisted_pt = "(ATENÇÃO: apenas uma compra permitida. Escolha a quantidade correta) Você está na whitelist de pré-venda! 🎉";
