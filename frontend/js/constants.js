...
const welcome_p = 'The Nomad Tigers NFT Project is a decentralized NFT Collection. A non-fungible token (NFT) is a non-interchangeable unit of data stored on a blockchain, a form of digital ledger, that can be sold and traded.  ';
