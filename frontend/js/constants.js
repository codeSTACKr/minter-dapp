...
const welcome_p = "The OC-GEN Project is a new and fun way to generate random original characters! Out of ideas? Want to add new characters to your story? just collecting characters? Then you're in the right place! <br> No roadmap! This is all about the ART and creating FUN characters! <br> (<b><strong> might </strong></b> airdrop some nice things to owners tho) <br> <b> :) </b>";
...
const button_presale_mint_whitelisted = "Mint your original character!";
const button_presale_mint_not_whitelisted = "Get on the Whitelist";
const button_presale_already_minted = "Already minted. :)";
const button_public_mint = "Mint Your original character.";
