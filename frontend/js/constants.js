const contractAddress = "0x56aEB7C1a3ebD311c0d1345F5CF31BE91a114c83"; // Replace with your own contract address
const chain = 'goerli'; // goerli, polygon, or ethereum

const welcome_h1 = "Welcome to the Eggy Faces Collection!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Eggy Faces NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
