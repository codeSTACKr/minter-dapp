...
const content_menu_about = "EKC is a collection of 4,319 NFTs (unique digital assets residing in the Polygon blockchain) that represents the return of the emo movement in Brazil and in the world. The club's goal is to create a community to promote and interact with the emo culture, besides providing exclusive benefits to the NFT holders such as concerts and establishments tickets, access to a merch store, and exclusive access to  partner bands.";
...
const content_menu_about_pt = 'EKC é uma coleção de 4.319 NFTs (artes digitais únicas que vivem na blockchain da Polygon) de Emo Kids representando a volta do movimento emo no Brasil e no mundo.  O objetivo do club é criar uma comunidade para divulgar e interagir com a cultura emo, além de fornecer benefícios exclusivos aos portadores do NFT tais como entradas para shows, estabelecimentos, acesso a uma loja de roupas do club, e acesso exclusivo a bandas parceiras.'
