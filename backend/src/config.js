...
const namePrefix = "Nomad Tigers";
const description = "Nomad Tigers The Best NFT Collection!";
...
const CONTRACT_NAME = 'Nomad Tigers';
const CONTRACT_SYMBOL = 'NTS';
...
const ROYALTY_ADDRESS = "0x4017dA0DF1e1E460e8f0Fe02398bdcf03c28a8C4"; // Address that will receive the royalty
